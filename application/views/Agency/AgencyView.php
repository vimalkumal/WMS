		...
		<div class="col-md-12">
			<div class="strip">
				<div class="title-strip">
					<i class="fas fa-industry"></i> Agency Detail
					<span class="float-right edit-agencyBTN">
						<a href="<?= base_url()?>index.php/Agency/AgencyController/editAgency" >
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-4"><h5 class="title-label">Email</h5><?= $agency_data['vAgencyEmail']?></div>
						<div class="col-md-4"><h5 class="title-label">Phone No</h5><?= $agency_data['iPhoneNo']?></div>
					</div>	
				</div>
                    ...
                    <div class="row">
                    	...
                    	<div class="col-11">
                    		<address style="line-height: 30px;">
		                      ...
		                      <?= $agency_data['city'] ?>  - <?= $agency_data['iPincode'] ?><br>
		                      <?= $agency_data['state'] ?>, <?= $agency_data['country'] ?>,
