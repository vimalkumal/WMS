...
<body>
 ...
 <div class="container rounded bg-white mt-5">
    <div class="row" style="border: 2px #388e3c solid;margin-bottom: 15px;">
        ...
        <div class="col-md-8">
            <form method="post" action="<?= base_url()?>index.php/Agency/AgencyProfileController/changeUserDetails" id="agencyProfile">
    ...
    <div class="modal fade" id="Edit_Profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?= base_url()?>index.php/Agency/AgencyProfileController/changeProfileImage" method="post" enctype="multipart/form-data" id="userImageForm" name="userImageForm" >
