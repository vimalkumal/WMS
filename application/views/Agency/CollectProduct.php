...
<body>
	...
	<div class="contant">
	<form method="POST" action="<?=base_url()?>index.php/Agency/AgencyRequestController/setCollectedProductRequestData">
	<div class="contant-request-authonticat">
		...
		<div class="row">
			<div class="col-md-2">
				Product Collection PIN<em>*</em>
			</div>
			<div class="cols-md-3">
				<input type="password" name="pPin" placeholder="Product Collection Code" class="form-control" required="">		
			</div>
		</div>
