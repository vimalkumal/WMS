		...
		<table id="requestTable" class="display" style="width:100%">
	        ...
	        <tbody>
	        	...
	        	foreach ($request_data as $key => $value){
	        		if(strval($value['dtReceivedDate'])=="0000-00-00 00:00:00"){
	        			$value['dtReceivedDate']=tba_value();
	        		}
	        		else{
	        			$value['dtReceivedDate']=date("d/m/Y ",strtotime($value['dtReceivedDate']));
	        		}
	        	?>
	            <tr>
	            	...
	            	<td class="text-capitalize"><?= $value['agency_name'] ?></td>
