               ...
               <!-- <i class="fa fa-user-circle fa-7x "></i> -->
                <div class="img-wrapper">
                  <img class="img-responsive"
                       src="<?= base_url()?>assets/images/UserProfileImages/<?= $admin_info['vUserImage']?>">
                ...
                <span class="font-weight-bold text-capitalize" style="margin-top: 10px;"><?= $admin_info['vName']?></span>
                <span class="text-black-50 "><?= $admin_info['vEmail']?></span>
            </div>
        </div>
        <div class="col-md-8">
            <form method="post" action="<?= base_url()?>index.php/Admin/AdminProfileController/changeAdminDetails" id="adminProfile">
            <input type="hidden" name="hUserId" value="<?= $admin_info['iUserId']?>">
            <input type="hidden" name="hUserEmail" value="<?= $admin_info['vEmail']?>">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3"> 
                    <h5 class="text-right" style="margin-left: 5px; margin-top: 7px;">Admin Profile</h5>
                </div>
                <div class="row mt-2">
                    <div class="form-group col-md-6">
                        <label for="fname">First Name</label>
                        <input type="text" name="tFirstName" class="form-control text-capitalize" id="fname" placeholder="Uaer First Name" value="<?= $admin_info['vFirstName']?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="lname">Last-Name</label>
                        <input type="text" name="tLastName" class="form-control text-capitalize" id="lname" placeholder="User Last Name" value="<?= $admin_info['vLastName']?>">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" name="eUserEmail" class="form-control" id="jdate" placeholder="User Email " value="<?= $admin_info['vEmail']?>" disabled="true">
                        <small class="form-text text-muted" style="padding-left: 10px;">You cannot change your Email.</small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="mno">Mobile Number</label>
                        <input type="text" name="tMobileNumber" class="form-control" id="mno" placeholder="User Mobile No" value="<?= $admin_info['iMobileNo']?>">
                    </div>
    ...
    <div class="modal fade" id="Edit_Profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?= base_url()?>index.php/Admin/AdminProfileController/changeProfileImage" method="post" enctype="multipart/form-data" id="userImageForm" name="userImageForm" >
              <div class="modal-body"> 
                  <input type="hidden" name="hUserId" value="<?= $admin_info['iUserId']?>" id="hUserId">
